...
import { StudiesList } from "./pages/explore/studies-list";
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      {/* Detail routes (stubs for now) — outside the browse shell. */}
      <Route path="explore/locus/:id" element={<DetailStub kind="locus" />} />
      <Route path="explore/gene/:symbol" element={<DetailStub kind="gene" />} />
      <Route path="explore/trait/:id" element={<DetailStub kind="trait" />} />
      <Route path="explore/study/:tag" element={<DetailStub kind="study" />} />
